...
ifdef RVCT_VERSION_569
  ifeq ($(strip $(RVCT_VERSION_569)), TRUE)
  DIR_ARM        =  C:\PROGRA~1\ARM\RVCT
  endif
endif
ifndef RVCT_VERSION_569 
  DIR_ARM        =  C:\PROGRA~1\ARM\RVCT
endif
...
BLUETOOTH_SUPPORT_CHIP = BTMTK_MT6601 BTMTK_MT6611 BTMTK_MT6612 BTMTK_MT6236 BTMTK_MT6256 BTMTK_MT6276 BTMTK_MT6616 BTMTK_MT6622 BTMTK_MT6626 BTMTK_MT6612_22_26 BTMTK_MT6921 BTMTK_MT6612_22 BTMTK_MT6612_26 BTMTK_MT6622_26 BTMTK_MT6255 BTMTK_MT6922 BTMTK_MT6250 BTMTK_MT6260 BTMTK_MT6261
# NONE, BTMTK, BTMTK_MT6601, BTMTK_MT6611, BTMTK_MT6612, BTMTK_MT6236, BTMTK_MT6256, BTMTK_MT6276, BTMTK_MT6616 BTMTK_MT6612_22_26 BTMTK_MT6921 BTMTK_MT6255 BTMTK_MT6922 BTMTK_MT6250 BTMTK_MT6260 TMTK_MT6261
...
ifdef BLUETOOTH_SUPPORT
  ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    ...
    COM_DEFS    +=  __BT_SUPPORT__ __BT_SEQ_SUPPORT__
    ...
    ifeq ($(filter $(strip $(BLUETOOTH_SUPPORT)),$(BLUETOOTH_SUPPORT_CHIP)),)
      ifneq ($(strip $(BT_SPP_SERVER)),NONE)
        $(call DEP_ERR_SETA_OR_OFFB,BLUETOOTH_SUPPORT,BTMTK_MT6601/BTMTK_MT6611/BTMTK_MT6612/BTMTK_MT6236/BTMTK_MT6256/BTMTK_MT6276/BTMTK_MT6616/BTMTK_MT6622/BTMTK_MT6626/BTMTK_MT6612_22_26/BTMTK_MT6921/BTMTK_MT6255/BTMTK_MT6922/BTMTK_MT6250/BTMTK_MT6260/BTMTK_MT6261,BT_SPP_SERVER)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifneq ($(strip $(BT_SPP_CLIENT)),NONE)
        $(call DEP_ERR_SETA_OR_OFFB,BLUETOOTH_SUPPORT,BTMTK_MT6601/BTMTK_MT6611/BTMTK_MT6612/BTMTK_MT6236/BTMTK_MT6256/BTMTK_MT6276/BTMTK_MT6616/BTMTK_MT6622/BTMTK_MT6626/BTMTK_MT6612_22_26/BTMTK_MT6921/BTMTK_MT6255/BTMTK_MT6922/BTMTK_MT6250/BTMTK_MT6260/BTMTK_MT6261,BT_SPP_CLIENT)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
    ...
    ifeq ($(strip $(BT_SSP_SUPPORT)),TRUE)
...
ifdef BT_DIALER_SUPPORT
  ifeq ($(strip $(BT_DIALER_SUPPORT)),TRUE)
    ifneq ($(strip $(BT_HFG_PROFILE)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,BT_HFG_PROFILE,BT_DIALER_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(BCM_AT_SUPPORT)),TRUE)
      ifneq ($(strip $(MMI_VERSION)),PLUTO_MMI)
        $(call DEP_ERR_SETA_OR_OFFB,MMI_VERSION,PLUTO_MMI,BT_DIALER_SUPPORT)
        DEPENDENCY_CONFLICT = TRUE
      endif
...
ifdef BT_SSP_SUPPORT
  ifeq ($(strip $(BT_SSP_SUPPORT)),TRUE)
    ifeq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
      $(call DEP_ERR_ONA_OR_OFFB,BLUETOOTH_SUPPORT,BT_SSP_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(MMI_VERSION)),PLUTO_MMI)
      $(call DEP_ERR_SETA_OR_OFFB,MMI_VERSION,PLUTO_MMI,BT_SSP_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifdef BT_PRODUCT_LINE
  ifeq ($(strip $(BT_PRODUCT_LINE)),BT_BOX)
    ifeq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
      $(call DEP_ERR_ONA_OR_OFFB,BLUETOOTH_SUPPORT,BT_BOX)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(BLUETOOTH_VERSION)),BT_VER_30)
      $(warning ERROR: please set BLUETOOTH_VERSION as BT_VER_30 or close BT_BOX)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(BT_HFG_PROFILE)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,BT_HFG_PROFILE,BT_BOX)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(BT_OPP_PROFILE)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,BT_OPP_PROFILE,BT_BOX)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(BT_A2DP_PROFILE)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,BT_A2DP_PROFILE,BT_BOX)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(BT_AVRCP_PROFILE)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,BT_AVRCP_PROFILE,BT_BOX)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(BT_DIALER_SUPPORT)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,BT_DIALER_SUPPORT,BT_BOX)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(BT_SPEAKER_SUPPORT)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,BT_SPEAKER_SUPPORT,BT_BOX)
      DEPENDENCY_CONFLICT = TRUE
    endif

    COM_DEFS     += __MMI_BT_BOX__
    COM_DEFS     += __BT_BOX_SUPPORT__
    COM_DEFS     += __CHECK_CHIP_TYPE__
    COM_DEFS     += __BTBOX_KEYBOARD_STYLE__
...
ifdef NORFLASH_NON_XIP_SUPPORT
  ifeq ($(strip $(NORFLASH_NON_XIP_SUPPORT)),TRUE)
    NORFLASH_NON_XIP_SUPPORT_PLATFORM = MT6260 MT6261
...
HORIZONTAL_CAMERA_SUPPORT_SIZE = 128X128 128X160 176X220 240X320 240X400 320X480 360X640 480X800
  ...
  ifeq ($(strip $(LARGE_MIDI_FILE_SUPPORT)),TRUE)
    ...
    ifneq ($(strip $(MMI_VERSION)),PLUTO_MMI)
      ifneq ($(strip $(MMI_VERSION)),COSMOS_MMI)
        $(call DEP_ERR_SETA_OR_OFFB,MMI_VERSION,PLUTO_MMI/COSMOS_MMI,LARGE_MIDI_FILE_SUPPORT)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
    ifdef DRM_SUPPORT
...
SV5_PLATFORM = MT6276 MT6256 MT6251 MT6573 MT6255 MT6922 MT6250 MT6260 MT6261
...
ifeq ($(strip $(CBM_CONNECTION_MANAGER_SUPPORT)),TRUE)
  ifneq ($(strip $(MMI_VERSION)),PLUTO_MMI)
    ifneq ($(strip $(MMI_VERSION)),COSMOS_MMI)
      $(call DEP_ERR_SETA_OR_OFFB,MMI_VERSION,PLUTO_MMI/COSMOS_MMI,CBM_CONNECTION_MANAGER_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
...
ifdef FONT_ENGINE
  ifneq ($(strip $(FONT_ENGINE)),NONE)
    ...
    ifeq ($(filter $(call Upper,$(strip $(MAIN_LCD_SIZE))),240X320 320X240 240X400 320X480 360X640 480X800),)
      $(warning ERROR: FONT_ENGINE only supports 240X320, 320X240, 240X400, 320X480 360X640 480X800 MAIN_LCD_SIZE)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
MEDIA_PLAYER_VER_MAIN_LCD_SIZE = 128X160 176X220 240X320 240X400 320X480 320X240 360X640 480X800 
...
ifndef MRE_PACKAGE
  ...
  ifneq ($(filter COSMOS_MMI PLUTO_MMI,$(MMI_VERSION)),)
    ...
    ifeq ($(strip $(MRE_PACKAGE)),NONE)
       #COM_DEFS          += __TOPWELL_MMI_NO_MRE_FEATURES__       
       COM_DEFS          += __DISABLE_SANDBOX_LIB__   
       COM_DEFS          += __TOPWELL_MMI_MRE_SWITCH__
       
       COM_DEFS += __MRE_PACKAGE_SLIM__
       COM_DEFS += __NBR_CELL_INFO__
       COM_DEFS += MRE_SYS_MEMORY_SIZE=16    
    endif 
...
ifdef IMAGE_VIEWER_VER
  ifneq ($(strip $(IMAGE_VIEWER_VER)),NONE)
    IMAGE_VIEWER_VER_EX_SUPPORT_MAIN_LCD_SIZE = 176X220 240X320 240X400 320X480 320X240 360X640 480X800
...
ifeq ($(strip $(WIFI_BT_SINGLE_ANTENNA_SUPPORT)),TRUE)
  BT_SINGLE_ANTENNA_SUPPORT_CHIP = BTMTK_MT6612 BTMTK_MT6616 BTMTK_MT6236 BTMTK_MT6276 BTMTK_MT6256 BTMTK_MT6255 BTMTK_MT6921 BTMTK_MT6922 BTMTK_MT6250 BTMTK_MT6260 BTMTK_MT6261
...
ifdef FINGER_TOUCH_SUPPORT
  ifneq ($(strip $(FINGER_TOUCH_SUPPORT)),NONE)
    FINGER_TOUCH_SUPPORT_SUPPORT_LCD_SIZE = 240X400 240X320 320X240 320X480 480X800 
...
ifneq ($(strip $(YUVCAM_INTERPOLATION)),NONE)
  YUVCAM_INTERPOLATION_SUPPORT_PLATFORM = MT6235 MT6235B MT6253 MT6253E MT6253L MT6252 MT6252H MT6250 MT6260 MT6261
...
ifdef VCARD_SUPPORT
  ...
  ifeq ($(strip $(VCARD_SUPPORT)),SINGLE)
    COM_DEFS    += __TOPWELL_VCARD_SUPPORT_SINGLE__
    COM_DEFS    += __VCARD_SUPPORT__
    COMPLIST    += vcard
    COMMINCDIRS += vcard\include
  endif
  ifeq ($(strip $(VCARD_SUPPORT)),MULTIPLE)
    COM_DEFS    += __TOPWELL_VCARD_SUPPORT_MULTIPLE__
...
ZIMAGE_MUST_ENABLE_PLATFORM = MT6250 MT6260 MT6261
...
ifneq ($(strip $(ZIMAGE_SUPPORT)),TRUE)
  ifneq ($(filter $(strip $(PLATFORM)),$(ZIMAGE_MUST_ENABLE_PLATFORM)),)
    ifneq ($(strip $(ZIMAGE_MUST_ENABLE_EXCEPTION)),TRUE)
      $(warning ERROR: Please turn on ZIMAGE_SUPPORT on $(strip $(PLATFORM)).)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif

ifneq ($(filter MT6236% MT6252% MT6921 MT6256 MT6255 MT6922 MT6250 MT6260 MT6261,$(PLATFORM)),)
...
ifdef INTERGRAFX_SUPPORT
  ...
  ifneq ($(strip $(INTERGRAFX_SUPPORT)),NONE)
    MAIN_LCD_SIZE_VALID_RANGE = 240X320 240X400 320X480 480X800
  ...
  MAIN_LCD_SUPPORT_SIZE = 240X320 240X400 320X480 480X800
...
ifeq ($(filter BASIC L1S UDVT,$(strip $(call Upper,$(PROJECT)))),)
  ...
  ifdef FONT_RESOURCE
    ...
    ifeq ($(strip $(FONT_RESOURCE)),DEMO)
      ...
      ifeq ($(filter $(call Upper,$(strip $(MAIN_LCD_SIZE))),128X128 128X160 176X220 240X320 320X240 240X400 320X480 480X800),)
        $(warning ERROR: DEMO font only supports 128X128, 128X160, 176X220, 240X320, 320X240, 240X400, 320X480 and 480X800 MAIN_LCD_SIZE, for other MAIN_LCD_SIZE, please set FONT_RESOURCE=OFFICIAL)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifneq ($(strip $(MMIDIR)),lcmmi)
        ifneq ($(strip $(MAIN_LCD_SIZE)),$(BITMAP_FONT_EXCLUDE_LCD_SIZE))
...
SYNC_LCM_HW_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268 MT6253T MT6253 MT6516 MT6270A MT6256 MT6276 MT6253E MT6253L MT6252 MT6252H MT6921 MT6255 MT6922 MT6250 MT6260 MT6261
...
ifeq ($(filter COSMOS_MMI PLUTO_MMI NEPTUNE_MMI,$(strip $(call Upper,$(MMI_VERSION)))),)
...
ifdef PBCCH_SUPPORT
  ifeq ($(strip $(PBCCH_SUPPORT)),TRUE)
    ifeq ($(strip $(call Upper,$(PROJECT))),GSM)
      $(warning ERROR: GSM project does not support PBCCH_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
#TOPWELL Fuz modified
ifdef TOPWELL_HW_SPEAKER_TYPE 
     ifneq ($(strip $(TOPWELL_HW_SPEAKER_TYPE)),NONE)
           ifeq ($(strip $(TOPWELL_HW_SPEAKER_TYPE)),MODE_LHV_ALLIN)     
                VIBRATION_SPEAKER_SUPPORT_PLATFORM = MT6252 MT6250 MT6260 MT6261
            ...
            ifeq ($(strip $(TOPWELL_HW_SPEAKER_TYPE)),MODE_LXV_YHED)     
                VIBRATION_SPEAKER_SUPPORT_PLATFORM = MT6252 MT6250 MT6260 MT6261
                     ifeq ($(filter $(strip $(PLATFORM)) ,$(VIBRATION_SPEAKER_SUPPORT_PLATFORM)),)
                        $(warning ERROR: PLATFORM $(strip $(PLATFORM)) not support VIBRATION_SPEAKER_SUPPORT.)
                        DEPENDENCY_CONFLICT = TRUE
...
MDP_MULTIPLE_DISPLAY_BUFFER_PLATFORM = MT6253 MT6253T MT6253E MT6253L MT6253PMU MT6252 MT6252H MT6235 MT6268 MT6236 MT6276 MT6256 MT6255 MT6250 MT6922 MT6260 MT6261
...
32K_CRYSTAL_REMOVAL_SUPPORT_PLATFORM = MT6255 MT6250 MT6260 MT6261
...
ifdef BES_EQ_SUPPORT
  ifeq ($(strip $(BES_EQ_SUPPORT)),TRUE)
    EQ_FLEX_SUPPORT_PLATFORM = MT6268 MT6236 MT6276 MT6255 MT6256 MT6250 MT6260 MT6261
...
ALICE_SUPPORT_PLATFORM = MT6250 MT6260 MT6261
...
ifneq ($(filter $(ALICE_SUPPORT_PLATFORM), $(PLATFORM)),)
  ifeq ($(strip $(ALICE_SUPPORT)),FALSE)
    ifneq ($(strip $(INSIDE_MTK)),1)
      $(warning ERROR: PLEASE turn on ALICE_SUPPORT on $(PLATFORM))
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifeq ($(strip $(call Upper,$(PROJECT))),GSM)
  ifdef HOTSPOT_SUPPORT
    ifeq ($(strip $(HOTSPOT_SUPPORT)),TRUE)
      $(warning ERROR: GSM project does not support HOTSPOT_SUPPORT. Please turn off HOTSPOT_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifeq ($(strip $(DCM_COMPRESSION_SUPPORT)),TRUE)
  ...
  ifeq ($(strip $(DCM_COMPRESSION_DEP_CHECK_OK)),FALSE)
    ...
    $(warning ERROR:  9. PLEASE set DAF_DECODE to TRUE and set DCM_COMPRESSION_AUDIO_CODEC to TRUE and set PLATFORM to MT6250/MT6260/MT6261 or)
    $(warning ERROR: 10. PLEASE set MELODY_VER to DSP_WT_SYN and set DCM_COMPRESSION_AUDIO_CODEC to TRUE and set PLATFORM to MT6250/MT6260/MT6261)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
endif
...
ifeq ($(strip $(TIME_LAPSE_VIDEO_RECORDER)),ENABLE)
  ifeq ($(filter $(strip $(PLATFORM)), MT6250 MT6255 MT6260 MT6261),)
    $(warning ERROR: please disable TIME_LAPSE_VIDEO_RECORDER when PLATFORM is not MT6250 or MT6255 or MT6260 or MT6261)
    DEPENDENCY_CONFLICT = TRUE
  else
    ifeq ($(strip $(MMI_FEATURES_SWITCH)),FALSE)
...
GAS_SUPPORT_SUPPORT = MT6250 MT6260 MT6261
...
DCM_MM_IMEHW_SUPPORT_PLATFORM = MT6250 MT6260 MT6261
...
ifdef KINGMOVIE_FILE_FORMAT_SUPPORT
  ifeq ($(strip $(KINGMOVIE_FILE_FORMAT_SUPPORT)),TRUE)
    KINGMOVIE_SUPPORT_PLATFORM = MT6260 MT6261
...
ifdef DCM_MULTITRUNK
  ifneq ($(strip $(DCM_MULTITRUNK)),NONE)
    DCM_COMPRESSION_PARTIAL_LOADING_SUPPORT_PLATFORM = MT6260 MT6261
...
COM_DEFS +=  __MQTT_TASK_SUPPORT__
COMPLIST += dlinkmq 

# TOPWELL 
include make\Topwell_option_features.mak
