...
ifneq ($(filter __MQTT_TASK_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\MQTTTask\MQTTTaskSrc\MQTTTask.c
...
SRC_LIST +=  plutommi\mmi\SmsbtmapcApp\SmsbtmapcAppSrc\SmsUmInterAdp.c \
           ...
           plutommi\mmi\BtRemoteCapture\BtRmtCapMain.c \
...
ifneq ($(filter __TOPWELL_MMI_CUSTOM_CARE__ , $(strip $(MODULE_DEFS))),)
    INC_DIR += plutommi\MMI\Care\CareInc
endif

ifneq ($(filter __TOPWELL_MMI_SOS_INTEGRATION__ , $(strip $(MODULE_DEFS))),)
    INC_DIR += plutommi\MMI\SosIntegration\SosIntegrationInc
endif

ifneq ($(filter __TOPWELL_IMAXSP_SMS__ , $(strip $(MODULE_DEFS))),)                  
	INC_DIR += plutommi\mmi\IMAXSPSMS\imaxspsmsInc
endif 
ifneq ($(filter __MMI_GAME__,$(strip $(MODULE_DEFS))),)
    SRC_LIST += plutommi\mmi\funandgames\funandgamessrc\game.c
...
ifneq ($(filter __TOPWELL_MMI_CUSTOM_CARE__ , $(strip $(MODULE_DEFS))),)                  
	SRC_LIST += plutommi\mmi\Care\CareSrc\care.c
endif 
ifneq ($(filter __TOPWELL_MMI_CUSTOM_CARE__ , $(strip $(MODULE_DEFS))),)                  
	SRC_PATH += plutommi\mmi\Care\CareSrc
endif

ifneq ($(filter __TOPWELL_MMI_SOS_INTEGRATION__ , $(strip $(MODULE_DEFS))),)
	SRC_LIST += plutommi\mmi\SosIntegration\SosIntegrationSrc\SosIntegrationSrc.c
endif
ifneq ($(filter __TOPWELL_MMI_SOS_INTEGRATION__ , $(strip $(MODULE_DEFS))),)
	SRC_PATH += plutommi\mmi\SosIntegration\SosIntegrationSrc
endif

ifneq ($(filter __TOPWELL_IMAXSP_SMS__ , $(strip $(MODULE_DEFS))),)                  
	SRC_LIST += plutommi\mmi\IMAXSPSMS\imaxspsmsSrc\imaxsp_sms.c
endif          
ifneq ($(filter __TOPWELL_IMAXSP_SMS__ , $(strip $(MODULE_DEFS))),)                  
	SRC_PATH += plutommi\mmi\IMAXSPSMS\imaxspsmsSrc
endif
...
ifneq ($(filter  __MQTT_TASK_SUPPORT__, $(strip $(MODULE_DEFS))),)
INC_DIR += plutommi\mmi\MQTTTask\MQTTTaskInc
endif
...
ifneq ($(filter __ZMAEE_APP__, $(strip $(MODULE_DEFS))),)

SRC_PATH += plutommi\mmi\zmaee\mtk_impl\interface 
INC_DIR  += plutommi\mmi\zmaee\mtk_impl\include \
						hal\peripheral\inc 
						
SRC_LIST += plutommi\mmi\zmaee\mtk_impl\interface\zmaee_addrbook.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_display.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_file.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_fixedapp.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_gps.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_gsensor.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_helper.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_image.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_multimedia.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_net.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_porting.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_setting.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_shell.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_statusbar.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_stdlib.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_tapi.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_theme.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_message.c \
						plutommi\mmi\zmaee\mtk_impl\interface\zmaee_menu_helper.c

ifneq ($(filter __ZMAEE_REDUCE_DOWNLOAD__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mmi\zmaee\mtk_impl\interface\zmaee_tipdialog.c 
endif

ifeq ($(filter __ZMAEE_APP_TTS__, $(strip $(MODULE_DEFS))),)
SRC_PATH += plutommi\mmi\zmaee\mtk_impl\menu
SRC_LIST += plutommi\mmi\zmaee\mtk_impl\menu\zmaee_menu_app.c 
endif	

ifneq ($(filter __ZMAEE_SIMPLIFY_TTS__, $(strip $(MODULE_DEFS))),)
INC_DIR += plutommi\mmi\zmaee\simplify_tts\include
SRC_PATH += plutommi\mmi\zmaee\simplify_tts\interface
SRC_LIST += plutommi\mmi\zmaee\simplify_tts\interface\zmaee_simplify_tts_audio.c \
			plutommi\mmi\zmaee\simplify_tts\interface\zmaee_simplify_tts_platform.c \
			plutommi\mmi\zmaee\simplify_tts\interface\zmaee_simplify_tts_ui_menu.c
endif
