    ...
    switch (packet_type)
    {
        ...
        case PINGRESP:{
			...
			if (lastPingTime != 0) {
				...
				mqtt_fmt_print("\nPING PING PING PING PING PING RESP!!  currentTime_ms = %ld, sentInteval = %ld\n", currentTime_ms, sentInteval);
			} 
